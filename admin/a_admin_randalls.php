 ...
 /*  <label for="ad-status" style="font-size:80%;font-variant:small-caps;color:#333;">Length</label>*/             
    ...
    <div style="width:100%;background:#000000;padding:10px;"><img src="/images/admin-logo-header.png"/></div>
       ...
       <!--<div data-role="navbar" data-theme="b" ><ul><li><a href="#"><h3 style="text-shadow:none;margin:0px;">Beer Inventory</h3></a></li></ul></div>-->
        ...
        <div data-role="navbar" data-theme="a" ><ul  data-theme="a" ><li  data-theme="a" ><a href="#" data-theme="a" data-inline="true" id="reboot"><h4 style="text-shadow:none;margin:0px;">Reboot</h4></a></li><li  data-theme="a" ><a href="#" data-theme="a" data-inline="true" id="rebootport"><h4 style="text-shadow:none;margin:0px;">Portrait</h4></a></li><li  data-theme="a" ><a href="#" data-theme="a" data-inline="true" id="rebootland"><h4 style="text-shadow:none;margin:0px;">Normal</h4></a></li><li  data-theme="a" ><a href="#" data-theme="a"  data-inline="true" id="refresh"><h4 style="text-shadow:none;margin:0px;">Refresh</h4></a></li><li  data-theme="a" ><a href="#" data-theme="a"  data-inline="true" id="shutdown"><h4 style="text-shadow:none;margin:0px;">Shutdown</h4></a></li></ul></div>
