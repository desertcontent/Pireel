...
<html>
    <head>
    <title>PiReel Control Panel</title>
    <meta charset="utf-8"> 
     ...
     var wineview = 'ACTIVE';
      ...
      function onWineAvailable(data, status)
       ...
       // var city = data.wines[0].region.lineage[2].name+'-'+data.wines[0].region.lineage[1].name+'-'+data.wines[0].region.lineage[0].name; 
        ...
        {alert('errorwinelist');alert(status);}
         ...
         function onSuccessWineList(data, status)
        {
            ...
            if(data[key].wine_status == 'INACTIVE'){$theme='c';}else if(data[key].wine_status == 'ACTIVE'){$theme='e';} else {$theme='a';}
...
// AD MANAGEMENT
       ...
       /*  $("#ad-message").html('<h5 style="text-align:center;">'+msg+'</h5>').show('slow');
         ...
         // $("#splash-editor").text(data[0].ad_content);
          ...
          var navlist ='<li data-role="list-divider" data-theme="a"><span class="li-order-id" style="margin-left:0px;">Order</span><span style="margin-left:15px;">Description</span><span style="margin-left:5px;float:right;">Controls</span></li>';  
          Object.keys(data).forEach(function(key) {
 ...
 /*  <label for="ad-status" style="font-size:80%;font-variant:small-caps;color:#333;">Length</label>*/             
		...
		// MAIN ADMIN PANEL SELECTIONS
			...
			// REBOOT  PORTRAIT
			$(document).on('click','#rebootport', function() {
		  		   var action = "rebootport";
                   ...
                   // error: onErrorVideo
	  		 	 ...
	  		 	 // REBOOT  LANDSCAPE
			$(document).on('click','#rebootland', function() {
		  		   var action = "rebootland";
    ...
    <div style="width:100%;background:#000000;padding:10px;"><img src="/images/admin-logo-header.png"/></div>
        <div data-role="header"  data-theme="a" data-mini="true">
       ...
       <!--<div data-role="navbar" data-theme="b" ><ul><li><a href="#"><h3 style="text-shadow:none;margin:0px;">Beer Inventory</h3></a></li></ul></div>-->
        ...
        <li><a style="margin-bottom:0px;" href="#" data-role="button" data-inline="true"  data-mini="true" data-theme="e" id="filterActive">Active</a></li>
        <li><a  style="margin-bottom:0px;" href="#" data-role="button" data-inline="true"  data-mini="true"  data-theme="c" id="filterInactive">Inactive</a></li>
         <li><a  style="margin-bottom:0px;" href="#" data-role="button" data-inline="true"   data-mini="true"  data-mini="true" data-theme="d" id="filterDraft">All</a></li>
        <!--<li><a  style="margin-bottom:0px;" href="#" data-role="button" data-inline="true"  data-mini="true"  data-theme="a" id="filterBottle">Bottles</a></li>
        ...
        <form id="specialsForm"  data-theme="a" >
			<div data-role="navbar" data-theme="a" ><ul  data-theme="a" ><li  data-theme="a" ><a  data-theme="a" href="#"><h3 style="text-shadow:none;margin:0px;">Manage Primary Ad</h3></a></li></ul></div>
                ...
                <button data-theme="a" id="upspecial" type="submit">Update Specials</button>
            </form>
            
                           <!-- Update Specials Form -->
        <form id="specialsForm3">
			<div data-role="navbar" data-theme="a" ><ul data-theme="a" ><li data-theme="a" ><a data-theme="a"  href="#"><h3 style="text-shadow:none;margin:0px;">Manage Ad Blocks </h3></a></li></ul></div>
                <div data-role="fieldcontain"  style="padding:15px;">
                <!-- Special 1 -->
                ...
                <button data-theme="a" id="upspecial3" type="submit">Update Specials Board</button>
            </form>


        <div id='splash-admin'  data-theme="a" >
        <div data-role="navbar" data-theme="a" ><ul  data-theme="a" ><li  data-theme="a" ><a href="#" data-theme="a" data-inline="true" id="reboot"><h3 style="text-shadow:none;margin:0px;">REBOOT</h3></a></li><li  data-theme="a" ><a href="#" data-theme="a" data-inline="true" id="rebootport"><h3 style="text-shadow:none;margin:0px;">REBOOT PORTRAIT</h3></a></li><li  data-theme="a" ><a href="#" data-theme="a" data-inline="true" id="rebootland"><h3 style="text-shadow:none;margin:0px;">REBOOT LANDSCAPE</h3></a></li><li  data-theme="a" ><a href="#" data-theme="a"  data-inline="true" id="refresh"><h3 style="text-shadow:none;margin:0px;">REFRESH</h3></a></li><li  data-theme="a" ><a href="#" data-theme="a"  data-inline="true" id="shutdown"><h3 style="text-shadow:none;margin:0px;">SHUTDOWN</h3></a></li></ul></div>
		
		<div id="ad-editor-block">
		 		  
		<form id="adForm" data-theme="a" data-inset="true" style="padding:5px;" >
        ...
        <p>
           ...
           <label for="ad-id" style="font-size:80%;font-variant:small-caps;">Ad ID (Read Only)</label>
            ...
            <div  id="ad-type-block" data-theme="a">
              <fieldset data-role="controlgroup" data-type="horizontal" id="ad-type-control" data-theme="a">
    	    <input data-theme="a" type="radio" name="ad-type" id="ad-type-1" value="HTML"  checked="checked" /> 
         	<label for="ad-type-1">HTML</label>

         	<input data-theme="a" type="radio" name="ad-type" id="ad-type-2" value="Video"  /> 
         	<label for="ad-type-2">Video</label>

         	<input data-theme="a" type="radio" name="ad-type" id="ad-type-3" value="Module"  />
             ...
             <input data-role="button" data-theme="a" type="submit" id="adupdate" value="Add/Update Ad"/>
             </div>
    ...
    var config = {
     ...
     config.contentsCss = ['../css/display1_wine.css','../css/themes/pourhouse.css'];
	$('.splash-editor').ckeditor(config);
	</script> 
        </div>
        <div id="ad-nav-block" >
        <ul data-role="listview" data-inset="true" data-theme="a" id="sortable">
    ...
    <a href="#" data-role="button" data-icon="arrow-d"  data-iconpos="notext" data-mini="true">Down</a> 
        ...
        <div data-role="footer" data-theme="a"  data-position="fixed">
           <div data-role="navbar"   data-inset="false" >
				<ul>
				<li><a href="beerlist.html" data-iconpos="left" data-icon="beer" data-ajax="false"  >Beers</a></li>
				<li><a href="winelist.html" data-iconpos="left" data-icon="drink" data-ajax="false"  >Wines</a></li>
				<li><a href="a_admin_randalls.php" data-iconpos="left" data-icon="play" data-ajax="false" >Admin</a></li> 
				<li><a href="a_admin_portrait.php" data-iconpos="left" data-icon="play" data-ajax="false" >AdminB</a></li>  
				</ul> 
		 </div>            
        </div>
    </div>
