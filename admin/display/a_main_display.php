...
<body style="background:transparent url(/images/splash.png) 0 0 no-repeat;overflow:hidden;">
       <!-- JQM PAGE-->
    <div data-role="page" id="listbeergrid" data-theme="d" style="background:transparent url(/images/splash.png) 0 0 no-repeat;" >
      <!--  <div data-role="header"  data-theme="b">
        ...
        <div data-role="content" style="padding:0px;" id="slides"> 
			...
			<div id="beerofday">
			 ...
			 <div id="vendorblock" style="position:absolute;top:0px;left:0px;z-index:10000;display:none;"><img alt="" src="../../images/datafog_logo_white.png" style="width:150px;margin-top:1000px;margin-left:25px;z-index:10000;" /> </div>
            </div>  
			<div id="logoblock" style="position:absolute;top:0px;left:0px;z-index:10000;"><!--<img alt="" src="../../images/datafog_logo_white.png" style="width:200px;margin-top:920px;margin-left:25px;z-index:10000;" />--><img alt="" src="/images/urbane_logo.png" style="width:150px;margin-top:1025px;margin-left:1750px;z-index:10000;" /></div>
