...
<body style="background:transparent;overflow:hidden;max-width:100%;">
<div id="diag">
	<?php  
...
mysqli_close($con);?>
       ...
       <!-- JQM PAGE-->
    <div data-role="page" id="listbeergrid" data-theme="d" style="background: transparent;width:1920px;" >
      <!--  <div data-role="header"  data-theme="b">
        ...
        <div data-role="content" style="padding:0px;" id="slides"> 
			...
			<div id="slideshow">	   
			 ...
			 <div id="vendorblock" style="position:absolute;top:0px;left:0px;z-index:10000;display:none;"><img alt="" src="../../images/randalls/randalls_logo_white.png" style="width:150px;margin-top:10px;margin-left:900px;z-index:10000;" /> </div>
            </div>  
			<div id="logoblock" style="position:absolute;top:0px;left:0px;z-index:10000;"><!--<img alt="" src="../../images/datafog_logo_white.png" style="width:200px;margin-top:920px;margin-left:25px;z-index:10000;" />--><img alt="" src="/images/randalls/randalls_logo_white.png" style="width:250px;margin-top:1850px;margin-left:1350px;z-index:10000;" /></div>
			
			<!--<img src="/admin/ckeditor/kcfinder/upload/images/pireel_logo.png" style="display:none;"/>
			 
			<img src="/admin/ckeditor/kcfinder/upload/images/greenhouse_flowers.jpg" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/logo-box_flower-bg.png" style="display:none;"/>
			<img src="/images/caption-bg-lighter.png" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/GBBC-Image.jpg" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/logoBackyard.png" style="display:none;"/>
			<img src="/images/caption-bg.png" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/front_desk(1).png" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/flower_arrangements.png" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/weber_background.png" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/weber_section.png" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/tentsale_background.png" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/christmas.jpg" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/christmas_greetings.jpg" style="display:none;"/>
			<img src="/admin/ckeditor/kcfinder/upload/images/info_center.png" style="display:none;"/>
			
			<iframe src="http://caanfloral.com" style="display:none;"></iframe>
			<iframe src="http://caanfloral.com/events.html" style="display:none;"></iframe>
			<iframe src="http://www.caanfloral.com/flowershop.html" style="display:none;"></iframe>
			<iframe src="/admin/a_admin_randalls.php" style="display:none;"></iframe> -->
   ...
   <script src="/js/jquery-1.9.1.js"></script>
     ...
     <!-- <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=weather" type="text/javascript"></script>-->

<!-- <script type="text/javascript" src="/js/gmap3.min.js"></script> 
 <div style="display:none;" id="my_map"></div>
<script>
$("#my_map").gmap3({
 map: {
    options: {
...
function movemap() {
	$('#marqueescroll').html(""); 
		   ...
		   $('#wines-gridview').html("");
		   $('#specials-ad').html("");	
	$('#ad-01-content').html($('#my_map').html()).trigger('create').show();;
}
</script>  -->   
 ...
 function loadad(adid){ 
		 $.ajax({
          ...
          $('#marqueescroll').html(""); 
		   ...
		   $('#wines-gridview').html("");
		   $('#specials-ad').html("");	
     	  $('#ad-01-content').html(data[0].ad_content).trigger('create').show();
         // $('#ad-01-content').trigger('create').show();
       ...
       // $('#vendorblock').show(10);
		...
		$('#wines-gridview').html("");
     	$('#beers-gridview').html("");
            ...
            $('#beers-gridview').append('<a href="#" data-role="button" data-inline="true" data-theme="b" class="col1 company-block" style="min-height:200px;padding-top: 0px;padding-bottom: 0px;"><div id="test"><h1 style="font-size:40px;">Pour House Grill</h1><h1  style="font-size:50px;padding-top:20px;">Craft Beer Menu</h1></div></a>'); 
