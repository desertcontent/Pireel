    ...
    <div data-role="page" id="main" data-theme="d"  >
        <div data-role="header"  data-theme="b">
             <div data-role="navbar"   data-inset="false" >
				...
				<li><a data-iconpos="left" data-icon="dollar" data-ajax="true" data-rel="back" id="admin-specials3">Board</a></li>
       ...
       <!--<div data-role="navbar" data-theme="b" ><ul><li><a href="#"><h3 style="text-shadow:none;margin:0px;">Beer Inventory</h3></a></li></ul></div>-->
        ...
        <form id="specialsForm">
			<div data-role="navbar" data-theme="a" ><ul><li><a href="#"><h3 style="text-shadow:none;margin:0px;">Manage Daily Specials</h3></a></li></ul></div>
                ...
                <!-- Special 1 -->
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special1h" id="special1h" value=""  />
                     
                    <label for="special1s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special1s" id="special1s" value=""  />
                    
                    <label for="special1d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special1d" id="special1d" value=""  />
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special2h" id="special2h" value=""  />
                     
                    <label for="special2s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special2s" id="special2s" value=""  />
                    
                    <label for="special2d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special2d" id="special2d" value=""  />
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special3h" id="special3h" value=""  />
                     
                    <label for="special3s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special3s" id="special3s" value=""  />
                    
                    <label for="special3d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special3d" id="special3d" value=""  />
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special4h" id="special4h" value=""  />
                     
                    <label for="special4s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special4s" id="special4s" value=""  />
                    
                    <label for="special4d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="special4d" id="special4d" value=""  />
        ...
        <form id="specialsForm3">
			<div data-role="navbar" data-theme="a" ><ul><li><a href="#"><h3 style="text-shadow:none;margin:0px;">Manage Daily Specials Board</h3></a></li></ul></div>
                <div data-role="fieldcontain"  style="padding:15px;">
                <!-- Special 1 -->
                    <label for="3special1" style="font-weight:bold;font-variant:small-caps;">special 1 Title</label>
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special1h" id="3special1h" value=""  />
                     
                    <label for="3special1s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special1s" id="3special1s" value=""  />
                    
                    <label for="3special1d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special1d" id="3special1d" value=""  />
                     
                     <label for="3special2" style="font-weight:bold;font-variant:small-caps;">Special 2 Title</label>
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special2h" id="3special2h" value=""  />
                     
                    <label for="3special2s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special2s" id="3special2s" value=""  />
                    
                    <label for="3special2d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special2d" id="3special2d" value=""  />
                    
                     <label for="3special3" style="font-weight:bold;font-variant:small-caps;">Special 3 Title</label>
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special3h" id="3special3h" value=""  />
                     
                    <label for="3special3s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special3s" id="3special3s" value=""  />
                    
                    <label for="3special3d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special3d" id="3special3d" value=""  />
                    
                     <label for="3special4" style="font-weight:bold;font-variant:small-caps;">Special 4 Title</label>
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special4h" id="3special4h" value=""  />
                     
                    <label for="3special4s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special4s" id="3special4s" value=""  />
                    
                    <label for="3special4d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special4d" id="3special4d" value=""  />
                    
                     <label for="3special5" style="font-weight:bold;font-variant:small-caps;">Special 5 Title</label>
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special5h" id="3special5h" value=""  />
                     
                    <label for="3special5s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special5s" id="3special5s" value=""  />
                    
                    <label for="3special5d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special5d" id="3special5d" value=""  />
                     
                     <label for="3special6" style="font-weight:bold;font-variant:small-caps;">Special 6 Title</label>
                    ...
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special6h" id="3special6h" value=""  />
                     
                    <label for="3special6s" style="font-size:80%;font-variant:small-caps;">Sub-Heading</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special6s" id="3special6s" value=""  />
                    
                    <label for="3special6d" style="font-size:80%;font-variant:small-caps;">Details</label>
                    <input maxlength="110"  style="font-size:80%;" type="text" name="3special6d" id="3special6d" value=""  />
