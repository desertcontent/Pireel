 ...
 /*  <label for="ad-status" style="font-size:80%;font-variant:small-caps;color:#333;">Length</label>*/             
    ...
    <div data-role="page" id="main">
       ...
       <!--<div data-role="navbar" data-theme="b" ><ul><li><a href="#"><h3 style="text-shadow:none;margin:0px;">Beer Inventory</h3></a></li></ul></div>-->
        ...
        <div data-role="navbar" data-theme="a" ><ul  data-theme="a" ><li  data-theme="a" ><a href="#" data-theme="a" data-inline="true" id="reboot"><h3 style="text-shadow:none;margin:0px;">REBOOT</h3></a></li><li  data-theme="a" ><a href="#" data-theme="a"  data-inline="true" id="shutdown"><h3 style="text-shadow:none;margin:0px;">SHUTDOWN</h3></a></li></ul></div>
