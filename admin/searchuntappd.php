...
file_put_contents("/var/www/admin/beerimages/".$beerid.".jpg", file_get_contents("".$beerlabel.""));  
file_put_contents("/var/www/admin/breweryimages/".$beerid.".jpg", file_get_contents("".$brewerylabel.""));  
echo $json;
?>