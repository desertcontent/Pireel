...
$conn = mysql_connect($dbhost, $dbuser, $dbpass);
 ...
 if($_POST['ad-id'] != ''){$sql = 'SELECT * FROM ads WHERE id = '.$_POST['ad-id'];}else{ $sql = 'SELECT * FROM ads WHERE id = 0';}
 if($_POST['adlist'] == 'all'){$sql = 'SELECT * FROM ads ORDER BY ad_title ASC';}
  if($_POST['adlist'] == 'loadsingle'){$sql = 'SELECT * FROM ads WHERE id = '.$_POST['loadid'];}
