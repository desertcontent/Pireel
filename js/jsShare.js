            ...
            return this.each(function() {
                ...
                function getButton(index, button, title) {
                    ...
                    return $('<li/>').append($('<a/>')
                                                    ...
                                                    .attr('alt', '').css({ width: 20, height: 20, marginTop: 3 })).hover(function() {
                                                        ...
                                                        var b = $(this);
                                                        if (settings.animate)
                                                            b.find('img').stop(false, true).animate({ height: 24, width: 24, marginTop:  5 }, 300);
                                                        ...
                                                        if (settings.animate)
                                                            $(this).find('img').stop(false, true).animate({ width: 20, height: 20, marginTop: 3 }, 300);
