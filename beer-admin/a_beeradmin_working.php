     ...
     function onBeerAvailable(data, status)
      ...
      //  $(document).ready(function() {
         ...
         // $("#splash-editor").text(data[0].ad_content);
          ...
          var navlist ='<li data-role="list-divider"><span class="li-order-id" style="margin-left:0px;">Order</span><span style="margin-left:15px;">Description</span><span style="margin-left:5px;float:right;">Control</span></li>';  
          Object.keys(data).forEach(function(key) {
            
              selectlist += '<option id="select_id'+data[key].id+'" value="'+data[key].id+'">'+data[key].id+' - '+data[key].ad_title+'</option>';
              navlist += '<li><div class="container_16"><div class="grid_2" style="height:45px"><h6 class="li-order-id">'+data[key].aorder+'</h6></div><div class="grid_10" style="height:45px">';
              if(data[key].astatus == "ON"){navlist +='<h3 style="color:green;">';}else{navlist +='<h3 style="color:red;">';}
              
              navlist += data[key].ad_title+'</h3><p>Ad ID: <span class="li-ad-id">'+data[key].id+'</span>   Timing: '+data[key].atiming+' seconds</p></div><div class="grid_4" style="height:45px;float:right;"><div style="float:right;"><a class="moveup" href="#" data-role="button" data-type="horizontal" data-inline="true" data-iconpos="notext" data-icon="arrow-u" data-theme="d">Up</a><a class="movedown" href="#" data-role="button" data-type="horizontal" data-inline="true" data-iconpos="notext" data-icon="arrow-d" data-theme="d">Down</a></div></div></div></li>';
			  });
		     ...
		     function onSuccessAdUpdate(data, status)
        {
         ...
         $("#splash-editor").val(data[0].ad_content);
          ...
          $("#select_id"+data[0].id+"").text(data[0].id+" - "+data[0].ad_title).trigger('create');
           ...
           function onErrorAdUpdate(data, status)
        {
            ...
            $("#admin-specials").on('click',function(){
        ...
        <p>
           ...
           <label for="ad-id" style="font-size:80%;font-variant:small-caps;">Ad ID (Read Only)</label>
    	    ...
    	    <input type="radio" name="ad-type" id="ad-type-1" value="html" checked="checked" /> 
         	...
         	<input type="radio" name="ad-type" id="ad-type-3" value="script"  />
         	<label for="ad-type-3">Script</label>
