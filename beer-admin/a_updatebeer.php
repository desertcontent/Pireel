<?php
   ...
   // file_put_contents("beerimages/img".$_POST['id'].".jpg", $image);
    file_put_contents("/var/www/beer-admin/beerimages/".$_POST['id'].".jpg", file_get_contents("".$_POST['beer_label_url'].""));  
    file_put_contents("/var/www/beer-admin/breweryimages/".$_POST['id'].".jpg", file_get_contents("".$_POST['brewery_label_url'].""));  
