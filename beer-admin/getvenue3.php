...
echo '<div id="lamenucontent" data-role="content" style="padding-top:15px;">';

echo '<ul id="menu-listview" data-role="listview" data-theme="a" data-inset="true" style="margin-top:0px;"  >';
...
// Start List Divider with Header Retrieved from above loop
 echo '<li data-role="listdivider" data-theme="f" data-mini="false" style="padding-left:25px;background-color:#000;color:#fff;" class="menu-divider">';
...
if ($itemname == '1/2 Dozen Chicken Wings'){echo '<i class="icon-chicken" style="margin-right:5px;"></i>';}
...
// Greens
if ($itemname == 'Wedge Salad'){echo '<img id="wedge" src="/list_icons/Salads.png" class="" style="margin-right:5px;height:25px;" />';}
