        ...
        <div data-role="content" style="background:#c7b299 url(/images/dartboard_bg.png) 0 0 no-repeat;padding:0px;" id="slides"> 
            ...
            <div id="slideblock">
         	<div id="beers-gridview">
		  	...
		  	<div   id="specials-ad" class="in-slide-content" style="width:95%;"></div>
			...
			<div id="logoblock" style="position:absolute;top:0px;left:0px;z-index:10000;"><img alt="" src="/beer-admin/ckeditor/kcfinder/upload/images/datafog_logo_white.png" style="width:200px;margin-top:970px;margin-left:1675px;z-index:10000;" /></div>
            </div> 
            </div>
   <script src="/js/jquery-1.8.2.min.js"></script>
...
// *********  LOAD SINGLE AD
 ...
 function loadad(adid){ 
		 $.ajax({
          ...
          //$('#ad-01-content').trigger('create').show('fast');
          $('#ad-01-content').trigger('create').fadeIn();
          }        
...
$('#beers-gridview').trigger('create').show('fast');
$('.beer-desc').dotdotdot();
	   ...
	   function listSpecials()
	   {
		...
		function onSuccessSpecials(data, status)
        {
           ...
           $('#specials-ad').html('<div id="specials" class="dropshad" style="display:inline-block;float:left;"><h2 class="header" style="text-align:center">Today\'s Specials</h2></div><div style="display:inline-block;float:right;width:49%;margin-top:50px;"><h2 class="header" style="font-size:60px;font-style:italic;margin-top:0px;">Try Our Philly Cheese Steak!</h2><img src="/images/cheesesteak_large.png" style="margin-top:50px;border:5px solid #000000;"/></div>');
			...
			var spec1 ='<h2 class="title">'+data.special_1+'</h2><h3 class="heading">'+data.special_1h+'</h3><h4 class="subheading">'+data.special_1s+'</h4><p  class="details">'+data.special_1d+'</p>';
			$('#specials').append(spec1);
			var spec2 ='<h2 class="title">'+data.special_2+'</h2><h3 class="heading">'+data.special_2h+'</h3><h4 class="subheading">'+data.special_2s+'</h4><p  class="details">'+data.special_2d+'</p>';
			$('#specials').append(spec2);
			var spec3 ='<h2 class="title">'+data.special_3+'</h2><h3 class="heading">'+data.special_3h+'</h3><h4 class="subheading">'+data.special_3s+'</h4><p  class="details">'+data.special_3d+'</p>';
			$('#specials').append(spec3);
			var spec4 ='<h2 class="title">'+data.special_4+'</h2><h3 class="heading">'+data.special_4h+'</h3><h4 class="subheading">'+data.special_4s+'</h4><p  class="details">'+data.special_4d+'</p>';
			$('#specials').append(spec4);
			$('#specials-ad').trigger('create').show('fast');
...
// *********  BEER OF THE DAY	   	   
	...
	$('#beer').trigger('create').show('fast');
	$('.sbeer-desc').dotdotdot();
         }
         }
// END LOAD BEER SLIDE
